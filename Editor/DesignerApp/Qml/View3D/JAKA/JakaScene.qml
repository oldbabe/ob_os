...
Node
{
    ...
    Connections
    {
        ...
        {
            jakaNode.setCoodTool(JRobot.tool.tran.x,JRobot.tool.tran.y,JRobot.tool.tran.z,
                                 JRobot.tool.rpy.rx,JRobot.tool.rpy.ry,JRobot.tool.rpy.rz);
            jakaNode.setCoodWorld(JRobot.world.tran.x,JRobot.world.tran.y,JRobot.world.tran.z,
